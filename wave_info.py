...
for fname in onlyWavfiles:
	...
	with contextlib.closing(wave.open(fname,'r')) as f:
		...
		if 120 >= duration > 60: between_60_and_120 +=1
...
print("# of files for {} between 60s and 120s: {}".format(indir, between_60_and_120))
print("# of files for {} between 60s and 20s: {}".format(indir, between_60_and_20))
